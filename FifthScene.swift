...
class FifthScene: SKScene{
    ...
    override func didMove(to view: SKView) {
        ...
        let buchstaben = SKSpriteNode(imageNamed: "backgroundAbcQ")
        buchstaben.anchorPoint = CGPointMake(0.5, 0.5)
        buchstaben.size = CGSize(width: self.size.width, height: self.size.height)
